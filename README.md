...
cluster_endpoint = https://A1ADBDD0AE833267869C6ED0476D6B41.gr7.eu-south-1.eks.amazonaws.com
...
clusters:
- cluster:
    server: https://A1ADBDD0AE833267869C6ED0476D6B41.gr7.eu-south-1.eks.amazonaws.com
  ...
  name: eks_gitlab-test-eks-TNajBRIF

contexts:
- context:
    cluster: eks_gitlab-test-eks-TNajBRIF
    user: eks_gitlab-test-eks-TNajBRIF
  name: eks_gitlab-test-eks-TNajBRIF

current-context: eks_gitlab-test-eks-TNajBRIF
