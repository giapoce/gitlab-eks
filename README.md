...
- cluster:
  ...
  name: eks_empatica-eks-TNajBRIF

contexts:
- context:
    cluster: eks_empatica-eks-TNajBRIF
    user: eks_empatica-eks-TNajBRIF
  name: eks_empatica-eks-TNajBRIF

current-context: eks_empatica-eks-TNajBRIF
